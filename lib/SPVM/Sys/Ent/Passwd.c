...
#ifdef _WIN32
  return env->die(env, stack, "The method \"pw_name\" in the class \"Sys::Ent::Passwd\" is not supported on this system", FILE_NAME, __LINE__);
#else
...
#ifdef _WIN32
  return env->die(env, stack, "The method \"pw_passwd\" in the class \"Sys::Ent::Passwd\" is not supported on this system", FILE_NAME, __LINE__);
#else
  void* obj_passwd = stack[0].oval;
...
#ifdef _WIN32
  return env->die(env, stack, "The method \"pw_uid\" in the class \"Sys::Ent::Passwd\" is not supported on this system", FILE_NAME, __LINE__);
#else
  void* obj_passwd = stack[0].oval;
...
#ifdef _WIN32
  return env->die(env, stack, "The method \"pw_gid\" in the class \"Sys::Ent::Passwd\" is not supported on this system", FILE_NAME, __LINE__);
#else
  void* obj_passwd = stack[0].oval;
...
#ifdef _WIN32
  return env->die(env, stack, "The method \"pw_gecos\" in the class \"Sys::Ent::Passwd\" is not supported on this system", FILE_NAME, __LINE__);
#else
  void* obj_passwd = stack[0].oval;
...
#ifdef _WIN32
  return env->die(env, stack, "The method \"pw_dir\" in the class \"Sys::Ent::Passwd\" is not supported on this system", FILE_NAME, __LINE__);
#else
  void* obj_passwd = stack[0].oval;
...
#ifdef _WIN32
  return env->die(env, stack, "The method \"pw_shell\" in the class \"Sys::Ent::Passwd\" is not supported on this system", FILE_NAME, __LINE__);
#else
  void* obj_passwd = stack[0].oval;
