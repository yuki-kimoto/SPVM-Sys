...
int32_t SPVM__Sys__IO__Fcntl__DN_ACCESS(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__DN_ATTRIB(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__DN_CREATE(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__DN_DELETE(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__DN_MODIFY(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__DN_MULTISHOT(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__DN_RENAME(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__FD_CLOEXEC(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_ADD_SEALS(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_DUPFD(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_DUPFD_CLOEXEC(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_GETFD(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_GETFL(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_GETLEASE(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_GETLK(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_GETLK64(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_GETOWN(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_GETOWN_EX(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_GETPIPE_SZ(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_GETSIG(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_GET_FILE_RW_HINT(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_GET_RW_HINT(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_GET_SEALS(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_NOTIFY(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_OFD_GETLK(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_OFD_SETLK(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_OFD_SETLKW(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_OWNER_PGRP(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_OWNER_PID(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_OWNER_TID(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_RDLCK(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_SEAL_FUTURE_WRITE(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_SEAL_GROW(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_SEAL_SEAL(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_SEAL_SHRINK(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_SEAL_WRITE(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_SETFD(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_SETFL(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_SETLEASE(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_SETLK(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_SETLKW(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_SETOWN(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_SETOWN_EX(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_SETPIPE_SZ(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_SETSIG(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_SET_FILE_RW_HINT(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_SET_RW_HINT(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_UNLCK(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__F_WRLCK(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__O_APPEND(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__O_ASYNC(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__O_CLOEXEC(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__O_CREAT(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__O_DIRECT(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__O_DIRECTORY(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__O_DSYNC(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__O_EXCL(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__O_LARGEFILE(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__O_NOATIME(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__O_NOCTTY(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__O_NOFOLLOW(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__O_NONBLOCK(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__O_PATH(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__O_RDONLY(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__O_RDWR(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__O_SYNC(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__O_TMPFILE(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__O_TRUNC(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Fcntl__O_WRONLY(SPVM_ENV* env, SPVM_VALUE* stack) {
