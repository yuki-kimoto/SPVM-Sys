...
int32_t SPVM__Sys__IO__Stat__S_CDF(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_ENFMT(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IF(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IFBLK(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IFCHR(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IFCMP(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IFDIR(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IFDOOR(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IFIFO(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IFLNK(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IFMPB(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IFMPC(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IFMT(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IFNAM(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IFNWK(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IFREG(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IFSHAD(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IFSOCK(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IFWHT(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_INSEM(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_INSHD(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IREAD(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IRGRP(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IROTH(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IRUSR(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IRWXG(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IRWXO(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IRWXU(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_ISBLK(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_ISCHR(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_ISDIR(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_ISFIFO(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_ISGID(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_ISLNK(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_ISREG(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_ISSOCK(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_ISUID(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_ISVTX(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IWGRP(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IWOTH(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IWUSR(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IXGRP(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IXOTH(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__IO__Stat__S_IXUSR(SPVM_ENV* env, SPVM_VALUE* stack) {
