...
#if defined(_WIN32)
  env->die(env, stack, "The \"new\" method in the class \"Sys::IO::Flock\" is not supported in this system", __func__, FILE_NAME, __LINE__);
...
#if defined(_WIN32)
  env->die(env, stack, "The \"l_type\" method in the class \"Sys::IO::Flock\" is not supported in this system", __func__, FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_NOT_SUPPORTED_CLASS;
#else
...
#if defined(_WIN32)
  env->die(env, stack, "The \"set_l_type\" method in the class \"Sys::IO::Flock\" is not supported in this system", __func__, FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_NOT_SUPPORTED_CLASS;
#else
...
#if defined(_WIN32)
  env->die(env, stack, "The \"l_whence\" method in the class \"Sys::IO::Flock\" is not supported in this system", __func__, FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_NOT_SUPPORTED_CLASS;
#else
...
#if defined(_WIN32)
  env->die(env, stack, "The \"set_l_whence\" method in the class \"Sys::IO::Flock\" is not supported in this system", __func__, FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_NOT_SUPPORTED_CLASS;
#else
...
#if defined(_WIN32)
  env->die(env, stack, "The \"l_start\" method in the class \"Sys::IO::Flock\" is not supported in this system", __func__, FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_NOT_SUPPORTED_CLASS;
#else
...
#if defined(_WIN32)
  env->die(env, stack, "The \"set_l_start\" method in the class \"Sys::IO::Flock\" is not supported in this system", __func__, FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_NOT_SUPPORTED_CLASS;
#else
...
#if defined(_WIN32)
  env->die(env, stack, "The \"l_len\" method in the class \"Sys::IO::Flock\" is not supported in this system", __func__, FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_NOT_SUPPORTED_CLASS;
#else
...
#if defined(_WIN32)
  env->die(env, stack, "The \"set_l_len\" method in the class \"Sys::IO::Flock\" is not supported in this system", __func__, FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_NOT_SUPPORTED_CLASS;
#else
