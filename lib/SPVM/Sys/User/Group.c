...
#if defined(_WIN32)
  env->die(env, stack, "The method \"gr_name\" in the class \"Sys::User::Group\" is not supported in this system.", __func__, FILE_NAME, __LINE__);
...
#if defined(_WIN32)
  env->die(env, stack, "The method \"gr_passwd\" in the class \"Sys::User::Group\" is not supported in this system.", __func__, FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_NOT_SUPPORTED_CLASS;
#else
  void* obj_group = stack[0].oval;
...
#if defined(_WIN32)
  env->die(env, stack, "The method \"gr_gid\" in the class \"Sys::User::Group\" is not supported in this system.", __func__, FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_NOT_SUPPORTED_CLASS;
#else
  void* obj_group = stack[0].oval;
...
#if defined(_WIN32)
  env->die(env, stack, "The method \"gr_mem\" in the class \"Sys::User::Group\" is not supported in this system.", __func__, FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_NOT_SUPPORTED_CLASS;
#else
  void* obj_group = stack[0].oval;
