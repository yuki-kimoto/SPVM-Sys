...
#if defined(_WIN32)
  env->die(env, stack, "The method \"pw_name\" in the class \"Sys::User::Passwd\" is not supported in this system.", __func__, FILE_NAME, __LINE__);
...
#if defined(_WIN32)
  env->die(env, stack, "The method \"pw_passwd\" in the class \"Sys::User::Passwd\" is not supported in this system.", __func__, FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_NOT_SUPPORTED_CLASS;
#else
  void* obj_passwd = stack[0].oval;
...
#if defined(_WIN32)
  env->die(env, stack, "The method \"pw_uid\" in the class \"Sys::User::Passwd\" is not supported in this system.", __func__, FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_NOT_SUPPORTED_CLASS;
#else
  void* obj_passwd = stack[0].oval;
...
#if defined(_WIN32)
  env->die(env, stack, "The method \"pw_gid\" in the class \"Sys::User::Passwd\" is not supported in this system.", __func__, FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_NOT_SUPPORTED_CLASS;
#else
  void* obj_passwd = stack[0].oval;
...
#if defined(_WIN32)
  env->die(env, stack, "The method \"pw_gecos\" in the class \"Sys::User::Passwd\" is not supported in this system.", __func__, FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_NOT_SUPPORTED_CLASS;
#else
  void* obj_passwd = stack[0].oval;
...
#if defined(_WIN32)
  env->die(env, stack, "The method \"pw_dir\" in the class \"Sys::User::Passwd\" is not supported in this system.", __func__, FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_NOT_SUPPORTED_CLASS;
#else
  void* obj_passwd = stack[0].oval;
...
#if defined(_WIN32)
  env->die(env, stack, "The method \"pw_shell\" in the class \"Sys::User::Passwd\" is not supported in this system.", __func__, FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_NOT_SUPPORTED_CLASS;
#else
  void* obj_passwd = stack[0].oval;
