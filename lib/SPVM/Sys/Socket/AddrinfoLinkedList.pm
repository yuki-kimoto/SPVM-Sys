...
The Sys::Socket::AddrinfoLinkedList class of L<SPVM> represents the linked list of L<struct addrinfo|https://linux.die.net/man/3/getaddrinfo> in the C language.
