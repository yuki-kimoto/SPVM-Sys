...
int32_t SPVM__Sys__Socket__Constant__POLLERR(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__Socket__Constant__POLLHUP(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__Socket__Constant__POLLIN(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__Socket__Constant__POLLNORM(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__Socket__Constant__POLLNVAL(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__Socket__Constant__POLLOUT(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__Socket__Constant__POLLPRI(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__Socket__Constant__POLLRDBAND(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__Socket__Constant__POLLRDNORM(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__Socket__Constant__POLLWRBAND(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Sys__Socket__Constant__POLLWRNORM(SPVM_ENV* env, SPVM_VALUE* stack) {
